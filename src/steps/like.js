...
When('I log in and go to discover and click on like button', function () {
		...
		browser.pause(2000)
		browser.$('/html/body/div/main/div[2]/div[2]/section/article[1]/div/div[2]/div[2]').click()
...
Then('The video must be liked', function () {
	...
	browser.pause(2000)
	var datainfo = browser.$('/html/body/div/main/div/div/div[4]/section/article[1]/div[1]/div[2]/div[2]').getAttribute('data-info');
	browser.$('/html/body/div/main/div/div/div[4]/section/article[1]/div[1]/div[2]/div[2]').click()
